...
const config: SnapConfig = {
  ...
  environment: {
    ...
    ON_CHAIN_ACCOUNT_TTL_MILLISECONDS:
      process.env.ON_CHAIN_ACCOUNT_TTL_MILLISECONDS ?? '',
    ...
    SEP41_TOKEN_BALANCE_TTL_MILLISECONDS:
      process.env.SEP41_TOKEN_BALANCE_TTL_MILLISECONDS ?? '',
  },
  polyfills: true,
};
