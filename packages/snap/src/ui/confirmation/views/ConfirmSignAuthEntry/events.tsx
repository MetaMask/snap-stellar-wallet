...
export enum ConfirmSignAuthEntryFormNames {
  Cancel = 'confirm-sign-auth-entry-cancel',
  Confirm = 'confirm-sign-auth-entry-confirm',
}
...
export function createEventHandlers(): Record<string, UserInputUiEventHandler> {
  return {
    [ConfirmSignAuthEntryFormNames.Cancel]: async (options) =>
      onCancelButtonClick(options),
    [ConfirmSignAuthEntryFormNames.Confirm]: async (options) =>
